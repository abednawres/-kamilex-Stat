...
const FolderHistogram = () => { 
    ...
    switch (timeFrame) {
      case 'Daily':
        return {
          ...
          datasets: [{
            data: [5, 10, 15, 20, 25, 30, 35] // Exemple de données quotidiennes
          }]
        };
      case 'Yearly':
        return {
          ...
          datasets: [{
            data: [200, 300, 400, 500] // Exemple de données annuelles
          }]
        };
      case 'Monthly':
      default:
  ...
  const data = getData(); // Obtenez les données basées sur le filtre sélectionné
...
export default FolderHistogram;
