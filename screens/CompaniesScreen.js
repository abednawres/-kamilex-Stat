...
export default function Companies({ navigation }) {
  ...
  const companiesData = [
    {
      id: 1,
      title: "NOVATION CITY",
      value: "Software company in Tunisia",
      description: "4.9 (37 Reviews)",
      imageSource: require("../assets/logo1.png"),
    },
    {
      id: 2,
      title: "PROXYM",
    ...
    },
    {
      ...
      value: "Software company in Tunisia",
      description: "4.9 (37 Reviews)",
      imageSource: require("../assets/logo3.png"),
    },
    {
      id: 4,
      title: "ENOVA ROBOTICS",
  ...
  const filteredCompanies = companiesData.filter((company) => {
    const matchesAlphabet = company.title
      .toLowerCase()
      .startsWith(alphabeticalOrder.toLowerCase());
    const matchesActivity = company.value
      .toLowerCase()
      .includes(fieldOfActivity.toLowerCase());
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.cardsContainer}>
        {(filteredCompanies.length > 0 ? filteredCompanies : companiesData).map(
          (company) => (
            <CompaniesCard
              key={company.id}
              title={company.title}
