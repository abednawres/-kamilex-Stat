...
export default function UsersManagement({ navigation }) {
  ...
  const usersData = [
    ...
    { id: 7, username: "Bob", role: "User", joiningDate: "2024-02-20", email: "bob@example.com", profileImage: require('../assets/profil2.png') },
    { id: 8, username: "Charlie", role: "Moderator", joiningDate: "2024-03-10", email: "charlie@example.com", profileImage: require('../assets/profil3.png') },
    { id: 9, username: "David", role: "User", joiningDate: "2024-04-05", email: "david@example.com", profileImage: require('../assets/profil4.png') },
        ...
        <View style={styles.pickerWithBorder}>
          ...
          >
            ...
            {rolesOptions.map((role) => (
              <Picker.Item key={role.id} label={role.label} value={role.value} />
            ))}
          </Picker>
        </View>
        ...
        <View style={styles.pickerWithBorder}>
          ...
          >
            ...
            {usersnamesOptions.map((username) => (
              <Picker.Item key={username.id} label={username.label} value={username.value} />
            ))}
          </Picker>
        </View>
      </View>
